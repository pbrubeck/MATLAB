...
t4=-(Dx2(g2,kd2)*S2(kd2,:)).*((S2(kd2,:)\A2(kd2,fliplr(g2))).');

Sig11=S4(kd4,:)*diag(Dx1(g1,g1)-Dx2(g2(1),g2(1))-t1*LL1-t2(1,:)*LL2)/S4(kd4,:);
Sig22=S4(kd4,:)*diag(Dx3(g3,g3)-Dx2(g2(2),g2(2))-t3*LL3-t2(2,:)*LL2)/S4(kd4,:);
Sig12=S4(kd4,:)*diag(-Dx2(g2(1),g2(2))-t4(1,:)*LL2)/S4(kd4,:);
Sig21=S4(kd4,:)*diag(-Dx2(g2(2),g2(1))-t4(2,:)*LL2)/S4(kd4,:);
